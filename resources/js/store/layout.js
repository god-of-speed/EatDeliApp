...
export default {
  ...
  getters:{
    getClientProperties(state) {
      return [state.clientWidth,state.clientHeight];
    }
  },
  mutations: {
    toggleChat(state) {
    ...
    setClientProperties(state,payload) {
  ...
  actions: {
    ...
    setClientProperties({commit},payload) {
      commit('setClientProperties',payload);
    }
  },
};
